...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--quick-split-path", type=Path, default=Path("eval/quick50.jsonl"))
    parser.add_argument("--final-split-path", type=Path, default=Path("eval/final150.jsonl"))
