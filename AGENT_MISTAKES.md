...
### MISTAKE-20260228-010
- id: MISTAKE-20260228-010
- status: active
- severity: high
- scope_tags: [code]
...
### MISTAKE-20260228-024
- id: MISTAKE-20260228-024
- status: active
- severity: medium
- scope_tags: [code]
...
### MISTAKE-20260228-025
- id: MISTAKE-20260228-025
- status: active
- severity: low
- scope_tags: [code]
...
- status: active
- severity: medium
- scope_tags: [docs, process]
- pattern: conflict resolution kept both sides of mistake-memory blocks, creating duplicate ids and duplicate entries in agent_mistakes
- prevention_rule: after resolving rebase or merge conflicts in AGENT_MISTAKES.md, run a uniqueness check on ids and dedupe repeated entries by normalized pattern + scope_tags + prevention_rule before continuing
- validation_check: run `awk '/^- id: MISTAKE-/{print $3}' AGENT_MISTAKES.md | sort | uniq -c` and verify every concrete id appears exactly once
- first_seen: 2026-03-01
- last_seen: 2026-03-01
- occurrence_count: 1
- evidence:
  - file:AGENT_MISTAKES.md:53
  - file:AGENT_MISTAKES.md:393
