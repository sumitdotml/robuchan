...
- Sat, 9 am: Doors open. Google for startups office
- 10 am: Briefing
- Sun, 4 pm: Judging starts
- 6:30 pm: Close

## Themes (AT LEAST 1 MUST BE FOLLOWED)

1. Finetuning a model
(sponsored by w&b) Finetune a model and get extraordinary results not possible with zero shot.
2. API: Anything goes
Need to use mistral models only
